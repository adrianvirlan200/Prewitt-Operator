...
public abstract class PrewittOperator extends Convolution {
	...
	//variabile private sunt vizibile doar in clasa curenta - incapsulare
	//se pot modifica prin intermediul setterilor
	//se pot afla valoare lor prin intermediul getterilor
