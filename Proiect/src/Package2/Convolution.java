...
//aceasta clasa implementeaza clasa interfata convolutie
// metodele sunt de tip public, pentru a putea fi accesate din clasele copil
public class Convolution implements InterfaceConvolution{
	
	//suprascriere - polimorfism
	@Override
	public double singlePixelConvolution(double[][] input, int x, int y, double[][] k, int kernelWidth,
			int kernelHeight) {
		double output = 0;
	...
	//suprascriere - polimorfism
	@Override
	public double[][] convolution2D(double[][] input, int width, int height, double[][] kernel, int kernelWidth,
			int kernelHeight) {
